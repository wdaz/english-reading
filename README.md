...
Gündəlik ingilis dili oxu mətnləri (A2–B1), Azərbaycan dilində izahlarla.
Claude Code routine tərəfindən avtomatik yaradılır: hər gün 10:00 və 19:00 (Bakı).
...
| `HISTORY.md` | İşlənmiş mövzuların indeksi. Təkrarın qarşısını alır. |
